...
\begin{document}
	...
	\section{Tarea}
	\begin{itemize}		
		\item Implementa una clase de arbol 2-3.
	...
	\begin{itemize}
		...
		\item \url{https://github.com/MisaelMarron/eda-lab-b-23a/tree/main/lab06}
	\end{itemize}
	
	\clearpage
	\section{Actividades  : La creacion de Arbol Binario de Busqueda}
	\begin{itemize}
		\item Elabore un informe implementando Arboles 2-3 con toda la lista de operaciones necesarias como insert() delete().     
		
	\end{itemize}
	
	\subsection{Commits Importantes:}
	\begin{lstlisting}[language=bash,caption={Mi primer commit importante es cuando agregue la clase Node .}][H]
	...
	\end{figure}
	\clearpage
	\begin{lstlisting}[language=bash,caption={Mi tercer commit es cuando agregue la clase main con todos los metodos terminados y terminamos el lab06}][H]
...
`	\begin{figure}[H]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\textwidth,keepaspectratio]{img/codigo3c.jpg}	
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\textwidth,keepaspectratio]{img/codigo3d.jpg}	
	\end{figure}
	\clearpage
