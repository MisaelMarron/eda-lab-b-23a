...
\newcommand{\itemOutput}{27 junio 2023}
...
\begin{document}
	...
	\section{Tarea}
	\begin{itemize}		
		\item Implementa una clase de arbol AVL.
	...
	\begin{itemize}
		...
		\item \url{https://github.com/MisaelMarron/eda-lab-b-23a/tree/main/lab05}
	\end{itemize}
	
	\clearpage
	\section{Actividades  : La creacion de Arbol Binario de Busqueda}
	\begin{itemize}
		\item Elabore un informe implementando Arboles AVLcon toda la lista de operaciones search(), getMin(), getMax(), parent(), son(), insert(), remove() rotateLeft(), rotateRight().     
		
	\end{itemize}
	
	\subsection{Commits Importantes:}
	\begin{lstlisting}[language=bash,caption={Mi primer commit importante es cuando agregue la clase Nodo .}][H]
		commit 2d1804f22c372b0bb3cd890f63a6964a2dfa029e
		Author: Misael Marron <mmarronl@unsa.edu.pe>
		Date:   Mon Jun 26 00:14:54 2023 -0500

    	Agregamos clase Nodo<T>
	\end{lstlisting}
	...
	\clearpage
	 ...
	 \begin{lstlisting}[language=bash,caption={Mi segundo commit mas importante es cuando agregue el metodo insert .}][H]
		commit 172dd67df73cc425f2f2afca7cc30e83d35e6689
		Author: Misael Marron <mmarronl@unsa.edu.pe>
		Date:   Mon Jun 26 01:07:39 2023 -0500
	...
	\clearpage
	\begin{lstlisting}[language=bash,caption={Mi tercer commit es cuando agregue el max y min y los metodos para rotar}][H]
		commit 3a2a47fb461e4a3a39434fb2f07cc4d8990fc2fa
		Author: Misael Marron <mmarronl@unsa.edu.pe>
		Date:   Mon Jun 26 01:30:24 2023 -0500
...
`	\begin{figure}[H]
	...
	\clearpage
	\begin{lstlisting}[language=bash,caption={Mi cuarto y ultimo commit es cuando termine y agregue parte grafica y test}][H]
		commit 39b92fdc8323be3073a8540f9243d992d6fbc794 
		Author: Misael Marron <mmarronl@unsa.edu.pe>
		Date:   Mon Jun 26 02:32:16 2023 -0500
